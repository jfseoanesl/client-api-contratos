...
public class FormPrincipalController implements Initializable {
    ...
    private final String PATH_IMAGES = "co/gov/deajvpar/gestcontractclient/images/";
    private final String PATH_IMAGES_ = "/src/main/resources/co/gov/deajvpar/gestcontractclient/images/";
    ...
    private void generateMenuUser() {
            ...
            Node rootIcon = new ImageView(new Image(PATH_IMAGES + "menu.png"));
            ...
            for (int i = 0; i < this.menuTitlesAndIcon.length; i++) {
                ...
                if (this.sesionUsuario.checkPermisoModulo(modulo)) {
                    ...
                    try {
                        Node icon = new ImageView(new Image(PATH_IMAGES + imageIcon));
